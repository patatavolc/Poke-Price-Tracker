...
export default function FeaturedCard({ cardData }) {
    ...
    return (
        <Link href={`/market/${cardData.id}`} className="block h-full">
            <div className="group relative bg-ui-border/30 backdrop-blur-sm rounded-xl shadow-xl overflow-hidden transition-all duration-300 hover:shadow-2xl hover:scale-105 border border-ui-border/50 h-full">
                {/* Brillo en hover */}
                        ...
                        >
                            <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    >
                                        {Math.abs(cardData.priceChange).toFixed(
                                            1,
                                        )}
                                        %
                                    </span>
